...
Hint
The built-in Array method, .includes(), might be helpful here, but you’re welcome to use a loop! Check out this Mozilla Developer Network documentation for more information on the .includes() method.

If you need a refresher on .filter(), check out our JavaScript exercise in addition to this Mozilla Developer Network documentation.
*/
